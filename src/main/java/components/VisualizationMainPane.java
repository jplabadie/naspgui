 ...
 * @author jlabadie
 */
public class VisualizationMainPane extends Stage {

    public VisualizationMainPane() {
        Browser b = new Browser();
        this.setScene(new Scene(b));
    }
    ...
    class Browser extends Region {
                ...
                new ChangeListener<Worker.State>() {
                    ...
                    public void changed(ObservableValue<? extends Worker.State> ov,
                        ...
                        if (newState == Worker.State.SUCCEEDED) {
                            ...
                            win.setMember("app", new Browser.JavaApp());
        ...
        /**
         * @return a Node used for visual spacing
         */
